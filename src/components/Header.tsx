          ...
          <nav className="hidden md:flex space-x-8">
            <Link
              ...
              className={`transition ${
                location.pathname === '/' ? 'text-gray-900 font-semibold' : 'text-gray-700 hover:text-gray-900'
              }`}
            >
              Home
            </Link>
            <Link
              to="/about"
              className={`transition ${
                location.pathname === '/about' ? 'text-gray-900 font-semibold' : 'text-gray-700 hover:text-gray-900'
              }`}
            >
              About
            </Link>
            <Link
              to="/products"
              className={`transition ${
                location.pathname === '/products' ? 'text-gray-900 font-semibold' : 'text-gray-700 hover:text-gray-900'
              }`}
            >
              Products
            </Link>
