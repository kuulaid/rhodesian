...
export const products = [{
    ...
    description: "This medicated shampoo with conditioner contains Fenobucarb-BPMC, which helps fight and treat parasitic infections, Guava Extract, which keeps pet bacteria-free, and Madre de Cacao Extract that is proven to fight and cure parasitic and fungal infections mildly, treating your dog with care"
  }, {
    id: 2,
