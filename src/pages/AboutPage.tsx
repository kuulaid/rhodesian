...
export function AboutPage() {
  ...
  return <div className="w-full">
    {/* About Us Hero Section - ANIMATION ADDED */}
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.p 
          ...
          initial="hidden"
          animate="visible"
          variants={{ ...defaultVariants, transition: { duration: 0.6, delay: 0.2 } }}
        >
        ...
        <motion.div 
          ...
          initial="hidden"
          animate="visible"
          variants={{ ...defaultVariants, transition: { duration: 0.8, delay: 0.4 } }}
        >
    ...
    {/* Core Values Section - ANIMATION ADDED */}
    ...
    {/* Mission and Vision Section - ANIMATION ADDED */}
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.h2 
        ...
        >
          ...
          <div className="space-y-8">
            ...
            <motion.div variants={{ ...defaultVariants, transition: { duration: 0.6, delay: 0.3 } }}>
              <h3 className="text-2xl font-bold text-[#f5c71d] mb-4">
                Vision
              </h3>
              <p className="text-gray-700 leading-relaxed">
    ...
    {/* History and Milestones Section - ANIMATION ADDED */}
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.h2 
          className="text-3xl md:text-4xl font-bold text-center mb-12"
